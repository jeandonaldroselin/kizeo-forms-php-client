...
class SearchFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('text_filter', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['text_filter'];
    }

    /**
     * Sets text_filter
     *
     * @param string|null $text_filter text_filter
     *
     * @return self
     */
    public function setTextFilter($text_filter)
    {
        if (is_null($text_filter)) {
            throw new \InvalidArgumentException('non-nullable text_filter cannot be null');
        }
        $this->container['text_filter'] = $text_filter;
