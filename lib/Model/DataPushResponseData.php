...
/**
 * DataPushResponseData Class Doc Comment
 *
 * @category Class
 * @package  KizeoFormsApi\Client
 * @author   OpenAPI Generator team
 ...
 */
class DataPushResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataPushResponse_data';
    ...
    */
    ...
    {
        if (is_null($data_id)) {
            throw new \InvalidArgumentException('non-nullable data_id cannot be null');
        }
