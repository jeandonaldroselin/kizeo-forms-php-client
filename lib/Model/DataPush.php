 ...
 */
class DataPush implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataPush';
    ...
    protected static $openAPITypes = [
        ...
        'fields' => '\KizeoFormsApi\Client\Model\FieldPush'
    ];
    ...
    {
        $this->setIfExists('recipient_user_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($recipient_user_id)) {
            throw new \InvalidArgumentException('non-nullable recipient_user_id cannot be null');
        }
     ...
     * Gets fields
     *
     * @return \KizeoFormsApi\Client\Model\FieldPush|null
     */
     ...
     * Sets fields
     *
     * @param \KizeoFormsApi\Client\Model\FieldPush|null $fields fields
     *
     * @return self
     */
